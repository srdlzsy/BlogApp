            ...
            if (context != null)
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { UserName = "serdalozsoy", Name = "Serdal Özsoy", Email = "info@serdalozsoy.com", Password = "123456", Image = "p1.jpg" },
                        new User { UserName = "erensarı", Name = "Eren Sarı", Email = "info@erensarı.com", Password = "123456", Image = "p2.jpg" }
                    );
                    context.SaveChanges();
                }
